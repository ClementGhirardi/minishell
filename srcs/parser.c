...
static t_ast	*parse_redirection(t_token **tokens, t_infos *infos)
{
	t_ast			*instr;
...
t_ast	*parse_after_bracket(t_token **tokens, t_ast *left, t_ast *brack, t_infos *infos)
{
	t_ast			*instr;
	t_token_type	type;
...
t_ast	*parsing_loop(t_token **tokens, t_ast *left, t_ast **brack, t_infos *infos)
{
	t_ast			*right;
	t_token			*tmp;
	t_token_type	type;
...
// 	t_ast		*left;
// 	t_ast		*brack;
// 	t_parser	parser_items;

// 	if (!tokens || !*tokens)
// 		return (NULL);
// 	parser_items.brack = NULL;
// 	parser_items.left = parse_pipeline(tokens);
// 	while (*tokens)
// 	{
...
// static t_ast	*parse_instructions(t_token **tokens, int status, char **env, char **input)
// {
// 	t_ast	*instr;
// 	t_ast	*cmd;
// 	t_token	*tmp;
...
// 			tmp = (*tokens)->bracket;
// 			*tokens = (*tokens)->next;
// 			instr = parse(&tmp, status, env, input);
// 		}
// 		else
// 		{
// 			cmd = parse_command(tokens);
...
// t_ast	*parse_pipeline(t_token **tokens, t_parser *parser_items, int status, char **env, char **input)
// {
// 	//t_ast	*left;
// 	//t_ast	*right;
// 	//t_ast	*brack;
...
// 	if (!tokens || !*tokens)
// 		return (NULL);
// 	parser_items->left = parse_instructions(tokens, status, env, input);
// 	while (*tokens && (*tokens)->type == TOKEN_PIPE)
// 	{
// 		parser_items->brack = NULL;
// 		if ((*tokens)->bracket)
// 		{
// 			tmp = (*tokens)->bracket;
// 			parser_items->brack = parse(&tmp, status, env, input);
// 			parser_items->left = ast_new_pipe(parser_items->left, parser_items->brack);
// 			*tokens = (*tokens)->next;
// 		}
// 		else
// 		{
// 			*tokens = (*tokens)->next;
// 			parser_items->right = parse_instructions(tokens);
// 			parser_items->left = ast_new_pipe(parser_items->left, parser_items->right);
// 		}
// 	}
// 	return (parser_items->left);
// }

// t_parser	parse_after_bracket(t_token **tokens, t_parser *parser_items, int status, char **env, char **input)
// {
// 	t_ast			*instr;
// 	t_token_type	type;
...
// 	type = (*tokens)->type;
// 	instr = parse_pipeline(tokens);
// 	parser_items->left->right = instr;
// 	instr->left = parser_items->brack;
// 	return (*parser_items);
// }

// t_parser	parsing_loop(t_token **tokens, t_parser *parser_items, int status, char **env, char **input)
// {
// 	//t_ast			*right;
// 	t_token			*tmp;
// 	t_token_type	type;
...
// 			tmp = (*tokens)->bracket;
// 			parser_items->brack = parse(&tmp, status, env, input);
// 			parser_items->left = ast_new_operator(parser_items->left, parser_items->brack, type);
// 			*tokens = (*tokens)->next;
// 		}
// 		else
// 		{
// 			*tokens = (*tokens)->next;
// 			parser_items->right = parse_pipeline(tokens);
// 			parser_items->left = ast_new_operator(parser_items->left, parser_items->right, type);
// 		}
// 	}
// 	return (*parser_items);
// }
...
// 	while (*tokens)
// 	{
// 		parser_items = parsing_loop(tokens, &parser_items, status, env, input);
// 		if (*tokens)
// 			parser_items = parse_after_bracket(tokens, &parser_items);
// 	}
// 	return (left);
// }