...
// 	while ((str[*i]))
// 		(*i)++;
// 	return (ft_strjoin_and_free(var, extract_var_name(
// 				ft_substr(str, start, *i - start), i, env)));
// }
...
// static char	*expander_first_quotes(char *str, int *i, char **env)
// {
// 	char	quote;
// 	char	*tmp;
// 	char	*var;
...
// 	if (str[0] == '\'' || str[0] == '\"')
// 	{
// 		tmp = expander_first_quotes(str, &i, env);
// 		return (free(str), tmp);
// 	}
// 	while (str[i])
// 	{
